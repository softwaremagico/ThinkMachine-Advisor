...
public class RandomProfilesFragment extends CharacterCustomFragment {
    ...
    protected void initData() {
        ...
        addSection(getResources().getString(R.string.profiles), linearLayout);

        try {
            List<RandomProfile> availableProfiles = RandomProfileFactory.getInstance().getElements(Locale.getDefault().getLanguage(),
                    ModuleManager.DEFAULT_MODULE);
            availableProfiles.forEach(randomProfile -> {
